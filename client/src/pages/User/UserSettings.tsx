...
export default function UserSettings(props: any) {
    ...
    return (
        <>
            ...
            <input value={props.stripeCustomerInfo?.name} onChange={handleChange} name="name" id="name" />
            <label htmlFor="line1">Address Line 1:</label>
            <input value={props.stripeCustomerInfo.address?.line1} onChange={handleChange} name="line1" id="line1" />
            <label htmlFor="line2">Address Line 2:</label>
            <input  value={props.stripeCustomerInfo?.address?.line2} onChange={handleChange} name="line2" id="line2" />
            <label htmlFor="city">City:</label>
            <input value={props.stripeCustomerInfo?.address?.city} onChange={handleChange} name="city" id="city" />
            <label htmlFor="state">State:</label>
            <input value={props.stripeCustomerInfo?.address?.state} onChange={handleChange} name="state" id="state" />
            <label htmlFor="postal_code">Zip Code:</label>
            <input value={props.stripeCustomerInfo?.address?.postal_code} onChange={handleChange} name="postal_code" id="postal_code" />
            </form>
